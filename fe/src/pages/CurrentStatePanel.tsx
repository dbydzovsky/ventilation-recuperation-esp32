...
export function CurrentStatePanel() {
    ...
    const configValid = currentState.configValid;
    ...
    return <div className={classes.header}>
        ...
        {!settingsValid && <p style={{textAlign: "center", color: "orange"}}><WarningIcon htmlColor={"orange"}/>Zjištěno neplatné pokročilé nastavení</p>}
        {!configValid && <p style={{textAlign: "center", color: "orange"}}><WarningIcon htmlColor={"orange"}/>Zjištěno neplatné nastavení</p>}
